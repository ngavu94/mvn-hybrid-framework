...
public class RegisterPageObject extends BasePage {
    ...
    public void enterToFirstnameTextbox(String firstName) {
        ...
        senkeysToElement(driver, RegisterPageUIs.FIRST_NAME_TEXTBOX, firstName);
    }

    public void enterToLastnameTextbox(String lastName) {
        waitForElementClickable(driver, RegisterPageUIs.LAST_NAME_TEXTBOX);
        senkeysToElement(driver, RegisterPageUIs.LAST_NAME_TEXTBOX, lastName);
    }
    ...
    public void enterToEmailTextbox(String email) {
        ...
        senkeysToElement(driver, RegisterPageUIs.EMAIL_TEXTBOX, email);
    }
    ...
    public void enterToCompanyNameTextbox(String companyName) {
        ...
        senkeysToElement(driver, RegisterPageUIs.COMPANY_NAME_TEXTBOX, companyName);
    }

    public void enterToPasswordTextbox(String password) {
        waitForElementVisible(driver, RegisterPageUIs.PASSWORD_TEXTBOX);
        senkeysToElement(driver, RegisterPageUIs.PASSWORD_TEXTBOX, password);
    }
    ...
    public void enterToPasswordConfirmTextbox(String passwordConfirm) {
        ...
        senkeysToElement(driver, RegisterPageUIs.PASSWORD_CONFIRM_TEXTBOX, passwordConfirm);
    }
