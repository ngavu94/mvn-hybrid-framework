...
public class Level_27_Data_POJO_Orange_HRM extends BaseTest {
...
//        this.password = UserObject.PASSWORD;
        ...
        userInfor.setEmailAddress("john");
        userInfor.setFirstName("nga");
        userInfor.setLastName("vu");
        userInfor.setCompanyName("Nexus");
    ...
    public void User_01_Register() {
        ...
        registerPage.enterToRegisterForm(userInfor);
